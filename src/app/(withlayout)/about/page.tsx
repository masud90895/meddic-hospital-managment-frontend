      ...
      <main className="isolate">
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                ...
                <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                  ...
                  <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                    ...
                    <div className="relative">
                      <Image
                        src="https://images.unsplash.com/photo-1638202993928-7267aad84c31?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80"
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                        width={528}
                        height={352}
                  ...
                  <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                    <div className="relative">
                      <Image
                        src="https://images.unsplash.com/photo-1550831107-1553da8c8464?auto=format&fit=crop&q=80&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&w=1974"
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                        width={528}
                        height={352}
              ...
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                ...
                <div className="mt-10 max-w-xl text-base leading-7 text-gray-700">
                  <p>
                    ...
                    well-being and quality of life for people worldwide. Our
                    unwavering commitment is to make healthcare a positive and
                    transformative experience, bridging the gap between
                    traditional practices and the evolving needs of the modern
                    world. Together, we are paving the way for a healthier, more
                    equitable tomorrow.
                  </p>
                  <p className="mt-10">
                    also Our mission is to revolutionize healthcare through
                    technology, accessibility, and patient-centric care. We aim
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our values are rooted in integrity, innovation, and empathy. We
              prioritize transparency, continuous improvement, and a commitment
              to serving our community, ensuring the highest standards of
              excellence
            </p>
          </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8 pb-10">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              I&apos;d be happy to help you provide a team description, but
              I&apos;ll need more specific information about your team, such as
              its size, the roles of team members, and its mission or purpose.
              Please provide more details, and I can assist you in creating an
              appropriate team description.
            </p>
          </div>
          <ul
            role="list"
